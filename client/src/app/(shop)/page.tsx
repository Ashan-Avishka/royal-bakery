...
const heroSlides: HeroSlide[] = [
  { id: "menu", brand: "Royal Bakery", headline: "Discover the Royal Bakery menu online.", support: "Browse cakes, pastries, breads, and sweets, then place your order online.", ctaLabel: "Explore the menu", ctaHref: "/products", imageSrc: "/images/slide-1.jpg", imageAlt: "Pastries and bakery products on a counter" },
  ...
  { id: "order", brand: "Royal Bakery", headline: "Plan and place your bakery order online.", support: "Use the menu to select products and review available fulfilment details at checkout.", ctaLabel: "Order online", ctaHref: "/products", imageSrc: "/images/slide-3.jpg", imageAlt: "Bread loaves on a bakery counter" },
];
