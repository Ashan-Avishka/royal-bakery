...
const promos = [
  {
    ...
    copy: "Browse cake options from the menu.",
    href: "/products",
    cta: "Browse cakes",
    image: "/images/celebration_cakes.png",
    alt: "Decorated celebration cake",
  },
  {
    title: "Breads and rolls",
    copy: "Browse bread and roll options from the menu.",
    href: "/products",
    cta: "Shop bread",
    image: "/images/bread_rolls.png",
      ...
      <div className="grid lg:grid-cols-2">
        {promos.map((promo, index) => (
          ...
          >
            ...
            />
            <div
              className={`relative z-10 flex h-full flex-col justify-end p-4 sm:p-11 ${index === 0 ? "lg:pl-[max(2.75rem,calc((100vw-72rem)/2+1.5rem))]" : ""}`}
            >
